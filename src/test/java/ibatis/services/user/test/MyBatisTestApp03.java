...
public class MyBatisTestApp03 {
	...
	public static void main(String[] args) throws Exception{
		...
		/*
		 * //1.User03.addUser Test Object obj = session.insert("UserMapper03.addUser",
		 * user); session.commit(); // select 를 제외하고 이 부분 반드시 해줘야 한다....mvc에서는 생략가능.
